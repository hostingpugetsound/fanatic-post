...
<?php elseif ( is_search() ) : ?>
  ...
  <div class="x-main full" role="main"  style="padding:40px;">
        ...
        <p class="p-landmark-sub"><span><?php _e( "Search Results for ", '__x__' ); echo '<strong>&ldquo;'; the_search_query(); echo '&rdquo;</strong>'; ?></span></p>
  </header>
...
<?php elseif ( is_404() ) : ?>
  ...
  <header class="x-header-landmark x-container max width">
    <h1 class="h-landmark"><span><?php _e( 'Nothing to see here', '__x__' ); ?></span></h1>
    <p class="p-landmark-sub"><span><?php _e( "We can't find the page you are looking for.", '__x__' ); ?></span></p>
  </header>

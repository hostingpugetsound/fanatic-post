...
$connectedTeam = new WP_Query( array(
  'connected_type' => 'players_to_team',
...
<div style="clear:both;"></div>
	  <ul id="navlist">
		  <li class="<?php if(strstr($_SERVER['REQUEST_URI'], 'player')) { echo "active"; } ?>">
                      <a href="<?php echo get_site_url();?>/player/<?php echo $post->post_name; ?>">The Arena <?php comments_number( '', '<span class="circleNum">1</span>', '<span class="circleNum">%</span>' ); ?></a>
      </li>
		  <li>
        <a href="<?php echo get_site_url();?>/article/?p=<?php echo $post->post_name; ?>&ptype=player">Articles <span class="circleNum"><?= $articlesNum; ?></span></a>
      </li>

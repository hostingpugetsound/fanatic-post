        ...
        <?php if ( x_get_option( 'x_footer_content_display', '1' ) == '1' ) : ?>
          <div class="x-colophon-content">
            <?php echo x_get_option( 'x_footer_content' ); ?>
              ...
              <a href="<?php echo home_url(); ?>/how-it-works">How FP Works</a> <a href="<?php echo home_url(); ?>/terms">Terms & Conditions</a> <a href="<?php echo home_url(); ?>/privacy">Privacy Policy</a> <a class="last" href="<?php echo home_url(); ?>/contact">Contact</a>
              <br /><br />
              <div class="copyright">Copyright <?php echo date('Y'); ?> FanaticPost</div>
          </div>
        <?php endif; ?>

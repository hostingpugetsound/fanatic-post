            ...
            <div class="x-container max width">
                ...
                <div id="loginControls">
                    ...
                    if ( is_user_logged_in() ):
                        ...
                        <a class="profilenav_link" href="#" style="margin-right:8px;"><span
                                    class="profilenav_dname"><?php echo $current_user->display_name; ?></span> <i
                        ...
                        ?><a class="profilenav_link" href="<?php echo get_site_url(); ?>/profile/"
                             style="margin-right:8px;"><i class="fa fa-user fa-lg"></i></a><?php
                    endif; ?>
